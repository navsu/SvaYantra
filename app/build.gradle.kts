...
android {
    ...
    defaultConfig {
        applicationId = "com.memandis.svayantra"
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // SvaYantra core stack
    implementation(dbModule(featureNotation = "svayantra"))
    implementation(localRepoModule(featureNotation = "svayantra"))
    implementation(remoteRepoModule(featureNotation = "svayantra"))
    implementation(useCaseModule(featureNotation = "svayantra"))
